...
strategy:
  ...
  max_impulse_bars: 10         # Макс. длительность развития импульса (свечей)
...
```bash
uv run python scripts/bybit_trader.py --symbols "SUIUSDT.P,BNBUSDT.P,ICPUSDT.P" --dry-run
```
...
Набор из **166 автоматических тестов** покрывает:
